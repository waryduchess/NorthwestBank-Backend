...
-- Una cuenta por tarjeta (prefijo 3000)
INSERT INTO cuentas (usuario_id, numero_cuenta, tipo, saldo) VALUES
  (1, '3000000000000001', 'ahorro',    15000.00),  -- cuenta de Josefina  (Nexus)
  (2, '3000000000000002', 'corriente', 32500.50),  -- cuenta de Erik      (Vertex)
  (3, '3000000000000003', 'ahorro',     8750.75),  -- cuenta de Luis      (Nexus)
  (4, '3000000000000004', 'corriente', 21000.00);  -- cuenta de Diego     (Vertex)
...
-- Solo tarjetas débito (tipo_tarjeta_id: 1=Nexus, 2=Vertex)
-- Cada tarjeta vinculada a su propia cuenta
...
INSERT INTO tarjetas (usuario_id, cuenta_id, tipo_tarjeta_id, numero_tarjeta, cvv, fecha_expiracion, nip, saldo) VALUES
  (1, 1, 1, '4030000000000001', '123', '05/28', '1111', 0.00),  -- Josefina  Nexus
  (2, 2, 2, '4040000000000002', '789', '11/27', '1111', 0.00),  -- Erik      Vertex
  (3, 3, 1, '4030000000000003', '654', '07/29', '1111', 0.00),  -- Luis      Nexus
  (4, 4, 2, '4040000000000004', '147', '09/27', '1111', 0.00);  -- Diego     Vertex
